...
export default function DailyBestSells() {
  ...
  return (
    <>
      <div className="container px-6 mx-auto bg-white font-outfit my-6 rounded-b-3xl">
        <nav>
            ...
            <div className="hidden md:flex items-center gap-4">
              {navItems.map((item, index) => (
                <a
                  ...
                  href="#"
                  className={clsx(
                    'text-base font-semibold text-[#253D4E] font-quicksand',
                    item.id === 1 && 'text-cyan'
                  )}
                >
                  {item?.name}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <aside className="flex flex-row md:flex-col justify-between text-white bg-[#3B54DA] rounded-2xl">
            ...
            <div className="flex-shrink-1 bg-brand-light1 text-[#000000] p-8 rounded-2xl">
