...
export default function HowItWorks() {
  ...
  return (
    <div className="bg-opacity-50 backdrop-filter backdrop-blur-lg min-h-screen bg-cover bg-gradient-to-r from-[#1D1B59] via-[#1D1B59] to-[#24217D] p-8 flex flex-col items-center mx-auto my-15 font-outfit bg-[url(/images/home/how-it-works/cover.png)] rounded-b-3xl">
