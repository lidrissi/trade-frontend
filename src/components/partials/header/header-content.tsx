...
const HeaderContent = ({ children }: { children: React.ReactNode }) => {
  ...
  if (config.sidebar === "two-column") {
    return (
      ...
      >
        <div
          className={cn(
            "bg-header relative flex flex-none items-center justify-between px-[15px] py-3 backdrop-blur-lg md:px-6 xl:ms-[300px]",
            {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "bg-header relative flex flex-none items-center justify-between px-[15px] py-3 backdrop-blur-lg md:px-6 xl:ms-[248px]",
          {
