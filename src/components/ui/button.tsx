...
const buttonVariants = cva(
  "inline-flex items-center justify-center px-4 md:px-6 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 transition-all focus-visible:outline-hidden focus-visible:hidden disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer",
  {
    variants: {
      color: {
        default:
        ...
        white: "bg-white text-black hover:bg-white/90 hover:ring-white",
      },
      variant: {
        default: "",
        outline:
